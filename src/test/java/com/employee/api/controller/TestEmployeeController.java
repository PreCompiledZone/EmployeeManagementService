...
public class TestEmployeeController {
	...
	private Employee getMockData() {
		return new Employee(1, "Amol Nilwarn", 24, "Software Developer", "amolnilwarn@gmail.com", 50000);
	}

	private Employee getInvalidTestData() {
		return new Employee(1, "Amol Nilwarn", -23, "Software Developer", "amolnilwarn@gmail.com", 50000);
	}
